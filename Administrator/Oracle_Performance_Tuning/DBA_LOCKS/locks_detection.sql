...
-- Description   : Checking locks and how to kill the blocking session

-------------------------------------------------------------------------------

/*

	how to kill the sessions
...
*/
		...
		--kill the session immediate
		ALTER SYSTEM KILL SESSION 'sid,serial#' IMMEDIATE;
		
		--alternative method to kill the session
		ALTER SYSTEM DISCONNECT SESSION 'sid,serial#' POST_TRANSACTION;
		
		--post_transcation waiting for session completed
		--immediate disconnect session 
		ALTER SYSTEM DISCONNECT SESSION 'sid,serial#' IMMEDIATE;
				

/*
	
	checking locks in the database	
...
-- Find all blocked sessions and who is blocking them(not testing)
		select 	sid,
				blocking_session,
				username,sql_id,
				event,
